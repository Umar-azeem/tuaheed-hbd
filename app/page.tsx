...
export default function BirthdayPage() {
  ...
  const duas = [
    ...
    },
    {
      arabic: "",
      transliteration:
        "Celebrating a wonderful person with a kind heart and inspiring spirit. May your day be filled with joy, laughter, and countless blessings.",
    },
    {
      arabic: "اللهم أعطه عمراً طويلاً وصحة وعافية",
      transliteration:
        "Allahumma a'tihi 'umran taweelan wa sihhatan wa 'aafiyah",
    ...
    },
    {
      ...
      transliteration:
        "Allahumma ihfazhu min kulli soo' wa adim 'alayhi ni'amak",
      english:
        "O Allah, protect him from all evil and continue Your blessings upon him",
    },
    {
      arabic: "اللهم اجعله من الصالحين وأسعده في الدنيا والآخرة",
      transliteration:
        "Allahumma ij'alhu min as-salihin wa as'idhu fi ad-dunya wa al-akhirah",
      english:
        "O Allah, make him among the righteous and grant him happiness in this life and the next",
    },
  ];
  ...
  return (
    <div className="max-h-screen md:min-h-screen bg-linear-to-br from-pink-50 via-red-50 to-rose-50">
      {showConfetti && (
        <Confetti width={windowSize.width} height={windowSize.height} />
      )}

      <audio ref={audioRef} src="/hbd.mp3" loop autoPlay muted={isMuted} />
      ...
      <section className="flex flex-col h-1/3 items-center justify-center  py-22 sm:py-20 md:py-50  text-center relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6 sm:space-y-8 max-w-2xl animate-fade-in hidden md:flex">
          <button
            ...
            className="inline-flex items-center gap-2 bg-linear-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 text-white font-bold py-1 md:py-3 sm:py-2 md:px-6 sm:px-8 rounded-full text-base sm:text-lg shadow-lg hover:shadow-2xl transition-all transform hover:scale-110 animate-pulse-button"
          >
      ...
      <section className="py-4 md:py-16 sm:py-20 px-4 bg-linear-to-br from-pink-100 to-red-100">
        <Cake />
      </section>
      ...
      <section className="py-5 sm:py-20 px-4 bg-white/50 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto">
          <div className="md:hidden flex justify-center  py-2 max-w-2xl animate-fade-in ">
            <button
              onClick={triggerConfetti}
              className="inline-flex items-center gap-2 bg-linear-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 text-white font-bold py-2 md:py-4 sm:py-2 px-4  rounded-full text-base sm:text-sm shadow-lg hover:shadow-2xl transition-all transform hover:scale-110 animate-pulse-button"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {memories.map((memory, index) => (
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-red-900/80 via-red-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4 sm:p-6">
                  <p className="text-white font-semibold text-sm sm:text-lg text-balance">
                    {memory.caption}
                  </p>
                </div>
              </div>
      ...
      <section className="py-4 md:py-16 sm:py-20 px-4 bg-linear-to-br from-pink-100 to-red-100">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-sm md:text-5xl font-bold text-center text-red-900 mb-2 sm:mb-4 text-balance">
            ...
            {duas.map((dua, index) => (
              ...
              >
                <div className="space-y-3 sm:space-y-4">
                  <p className="text-xl sm:text-2xl font-bold text-red-900 text-right leading-relaxed">
                    {dua.arabic}
                  </p>
      ...
      <section className="py-5 sm:py-20 px-4 bg-white/50 backdrop-blur-sm"></section>

      <section className="py-4 md:py-16 sm:py-20 px-4 bg-linear-to-br from-pink-50 to-red-50">
        <div className="max-w-2xl mx-auto text-center space-y-4 sm:space-y-6">
          ...
          <p className="text-base sm:text-lg text-red-800 leading-relaxed">
            May every moment of your life be filled with happiness, success, and
            the love of those around you. Here's to another year of growth,
          ...
          <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-linear-to-r from-pink-200 via-red-200 to-rose-200 rounded-xl sm:rounded-2xl border-2 border-red-500 shadow-lg animate-pulse">
            <p className="text-base sm:text-lg text-red-900 font-semibold">
              ✨ With Love & Best Wishes From ✨
            </p>
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-red-700 mt-2">
              Muhammad
            </p>
            <p className="text-sm sm:text-base text-red-800 mt-2">
