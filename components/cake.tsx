...
function Confetti({ active }: ConfettiProps) {
  const pieces = useRef<ConfettiPiece[]>(
    Array.from({ length: NUM_CONFETTI }, (_, i) => ({
      ...
      color: ["#FF6B6B","#FFD93D","#6BCB77","#4D96FF","#FF922B","#cc5de8","#f06595","#74c0fc"][i % 8],
...
function Flame({ i }: FlameProps) {
  return (
    ...
    >
      ...
      {/* wick */}
      <div style={{ width: 3, height: 22, background: "#2d1a00", borderRadius: 2 }} />
    </div>
  )
}
...
export default function CakeCutting() {
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background: "linear-gradient(135deg, #1a0533 0%, #2d0a4e 40%, #0a1a3d 100%)",
        display: "flex",
        flexDirection: "column",
        alignItems: "center",
    ...
    >
      ...
      <div style={{ position: "relative", width: 300, height: 340 }}>
        ...
        {phase !== "idle" && (
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ width: "100%", height: 3, background: "#ffffff33", marginTop: 12, borderRadius: 2 }} />
              <div style={{ width: "100%", height: 3, background: "#ffffff22", marginTop: 6, borderRadius: 2 }} />
              <div style={{ width: "100%", height: 3, background: "#ffffff22", marginTop: 6, borderRadius: 2 }} />
            </div>
            {/* Guard */}
            <div style={{ width: 36, height: 8, background: "#aaa", borderRadius: 2, boxShadow: "0 2px 4px #00000066" }} />
            {/* Blade */}
            <div style={{
              width: 0,
              height: 0,
        ...
        <div style={{
          ...
          {!isCut && (
            <div style={{ position: "relative", width: 96, height: 40, marginBottom: 0 }}>
              {[0, 1, 2].map(i => <Flame key={i} i={i} />)}
            </div>
          )}
          ...
          <div style={{
            ...
            {isCut ? (
              <div style={{ display: "flex", gap: 6 }}>
                <div style={{
                  width: 52, height: 50,
                  background: "linear-gradient(180deg, #ff9ec4 0%, #ff6baa 60%, #e8457e 100%)",
                  ...
                  {/* layers inside */}
                  <div style={{ position: "absolute", top: 15, left: 0, right: 0, height: 5, background: "#fff9" }} />
                  <div style={{ position: "absolute", top: 28, left: 0, right: 0, height: 5, background: "#ff6baa99" }} />
                </div>
                <div style={{
                  width: 52, height: 50,
                  background: "linear-gradient(180deg, #ff9ec4 0%, #ff6baa 60%, #e8457e 100%)",
              ...
              <div style={{
                width: 110, height: 50,
                background: "linear-gradient(180deg, #ffb8d9 0%, #ff6baa 60%, #e8457e 100%)",
                ...
                {/* sprinkles */}
                {[{l:15,t:20,r:15},{l:40,t:30,r:0},{l:65,t:18,r:30},{l:80,t:32,r:45}].map((s,i) => (
                  <div key={i} style={{
                    position: "absolute",
                    left: s.l, top: s.t,
                    width: 12, height: 4,
                    borderRadius: 4,
                    background: ["#FFD700","#6BCB77","#4D96FF","#FF922B"][i],
          ...
          <div style={{
            ...
            {isCut ? (
              <>
                <div style={{
                  width: 100, height: 60,
                  background: "linear-gradient(180deg, #c084fc 0%, #9333ea 60%, #7e22ce 100%)",
                  ...
                  <div style={{ position: "absolute", top: 20, left: 0, right: 0, height: 6, background: "#fff8" }} />
                  <div style={{ position: "absolute", top: 38, left: 0, right: 0, height: 6, background: "#c084fc88" }} />
                  {/* chocolate chips */}
                  {[{l:10,t:10},{l:60,t:28},{l:30,t:42},{l:75,t:14}].map((d,i) => (
                    <div key={i} style={{ position:"absolute", left:d.l, top:d.t, width:8, height:8, borderRadius:"50%", background:"#5b21b6" }} />
                  ))}
                </div>
                <div style={{
                  width: 100, height: 60,
            ...
            {isCut ? (
              <>
                <div style={{
                  ...
                  <div style={{ position: "absolute", top: 18, left: 0, right: 0, height: 6, background: "#fff8" }} />
                  <div style={{ position: "absolute", top: 38, left: 0, right: 0, height: 6, background: "#fb923c88" }} />
                  <div style={{ position: "absolute", top: 56, left: 0, right: 0, height: 6, background: "#fff6" }} />
                </div>
                <div style={{
                  width: 108, height: 70,
                  background: "linear-gradient(180deg, #fb923c 0%, #ea580c 60%, #c2410c 100%)",
              ...
              <div style={{
                width: 226, height: 70,
                background: "linear-gradient(180deg, #fdba74 0%, #ea580c 60%, #c2410c 100%)",
      ...
      {phase === "idle" && (
        <button
          ...
          onMouseEnter={e => { e.target.style.transform = "scale(1.06)"; e.target.style.boxShadow = "0 0 50px #c026d3aa, 0 8px 30px #00000066" }}
          onMouseLeave={e => { e.target.style.transform = "scale(1)"; e.target.style.boxShadow = "0 0 30px #c026d388, 0 4px 20px #00000044" }}
        >
          🍰 Cut the Cake
        </button>
      )}
      ...
      {showMessage && (
        <div style={{
          ...
          <div style={{
            ...
            fontWeight: 900,
            background: "linear-gradient(90deg, #FFD700, #ff6b6b, #c084fc, #4D96FF, #FFD700)",
